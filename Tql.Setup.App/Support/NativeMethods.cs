...
namespace Tql.Setup.App.Support
{
    ...
    public static class NativeMethods
    {
        ...
        public static string SHGetFolderPath(
            IntPtr hwndOwner,
            SpecialFolderCSIDL nFolder,
            IntPtr hToken,
            uint dwFlags
        )
        {
        ...
        public static NativeMethods.PKEY GetPkey(PropertyStoreProperty property)
        {
            switch (property)
            {
                case PropertyStoreProperty.AppUserModel_ID:
                    return NativeMethods.PKEY.AppUserModel_ID;
                case PropertyStoreProperty.AppUserModel_IsDestListSeparator:
                    return NativeMethods.PKEY.AppUserModel_IsDestListSeparator;
                case PropertyStoreProperty.AppUserModel_RelaunchCommand:
                    return NativeMethods.PKEY.AppUserModel_RelaunchCommand;
                case PropertyStoreProperty.AppUserModel_RelaunchDisplayNameResource:
                    return NativeMethods.PKEY.AppUserModel_RelaunchDisplayNameResource;
                case PropertyStoreProperty.AppUserModel_RelaunchIconResource:
                    return NativeMethods.PKEY.AppUserModel_RelaunchIconResource;
                case PropertyStoreProperty.AppUserModel_StartPinOption:
                    return NativeMethods.PKEY.AppUserModel_StartPinOption;
                ...
                case PropertyStoreProperty.Title:
                    return NativeMethods.PKEY.Title;
                default:
        ...
        public struct PKEY
        {
            ...
            public static readonly PKEY AppUserModel_StartPinOption = new PKEY(
                new Guid("9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3"),
                12
            );

            /// <summary>PKEY_AppUserModel_ExcludeFromShowInNewInstall</summary>
            public static readonly PKEY AppUserModel_ExcludeFromShowInNewInstall = new PKEY(
                new Guid("9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3"),
                8
            );
        }
