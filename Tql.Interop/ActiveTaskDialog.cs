...
namespace Tql.Interop
{
    ...
    public class ActiveTaskDialog : IWin32Window
    {
        ...
        ////        this.windowHandle,
        ////        (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_NAVIGATE_PAGE,
        ////        IntPtr.Zero,
        ////        //a NativeMethods.TASKDIALOGCONFIG value);
        ////}
        ...
        public bool ClickButton(int buttonId)
        {
            ...
            return NativeMethods.SendMessage(
                    this.handle,
                    (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_CLICK_BUTTON,
                    (IntPtr)buttonId,
                    IntPtr.Zero
                ) != IntPtr.Zero;
        }
        ...
        public bool SetMarqueeProgressBar(bool marquee)
        {
            ...
            return NativeMethods.SendMessage(
                    this.handle,
                    (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_MARQUEE_PROGRESS_BAR,
        ...
        public bool SetProgressBarState(ProgressBarState newState)
        {
            ...
            return NativeMethods.SendMessage(
                    this.handle,
                    (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_PROGRESS_BAR_STATE,
                    (IntPtr)newState,
                    IntPtr.Zero
                ) != IntPtr.Zero;
        ...
        public bool SetProgressBarRange(Int16 minRange, Int16 maxRange)
        {
            ...
            IntPtr lparam = (IntPtr)(
                (((Int32)minRange) & 0xffff) | ((((Int32)maxRange) & 0xffff) << 16)
            );
            return NativeMethods.SendMessage(
                    this.handle,
                    (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_PROGRESS_BAR_RANGE,
                    IntPtr.Zero,
                    lparam
                ) != IntPtr.Zero;
        ...
        public void SetProgressBarMarquee(bool startMarquee, uint speed)
        {
            ...
            NativeMethods.SendMessage(
                this.handle,
                (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_PROGRESS_BAR_MARQUEE,
        ...
        public bool SetContent(string content)
        {
            ...
            return NativeMethods.SendMessageWithString(
                    this.handle,
                    (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_ELEMENT_TEXT,
                    (IntPtr)NativeMethods.TASKDIALOG_ELEMENTS.TDE_CONTENT,
                    content
                ) != IntPtr.Zero;
        }
        ...
        public bool SetExpandedInformation(string expandedInformation)
        {
            ...
            return NativeMethods.SendMessageWithString(
                    this.handle,
                    (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_ELEMENT_TEXT,
                    (IntPtr)NativeMethods.TASKDIALOG_ELEMENTS.TDE_EXPANDED_INFORMATION,
                    expandedInformation
                ) != IntPtr.Zero;
        }
        ...
        public bool SetFooter(string footer)
        {
            ...
            return NativeMethods.SendMessageWithString(
                    this.handle,
                    (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_ELEMENT_TEXT,
                    (IntPtr)NativeMethods.TASKDIALOG_ELEMENTS.TDE_FOOTER,
                    footer
                ) != IntPtr.Zero;
        }
        ...
        public bool SetMainInstruction(string mainInstruction)
        {
            ...
            return NativeMethods.SendMessageWithString(
                    this.handle,
                    (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_ELEMENT_TEXT,
                    (IntPtr)NativeMethods.TASKDIALOG_ELEMENTS.TDE_MAIN_INSTRUCTION,
                    mainInstruction
                ) != IntPtr.Zero;
        }
        ...
        public void ClickRadioButton(int buttonId)
        {
            ...
            NativeMethods.SendMessage(
                this.handle,
                (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_CLICK_RADIO_BUTTON,
                (IntPtr)buttonId,
                IntPtr.Zero
            );
        }
        ...
        public void EnableButton(int buttonId, bool enable)
        {
            ...
            NativeMethods.SendMessage(
                this.handle,
                (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_ENABLE_BUTTON,
                (IntPtr)buttonId,
                (IntPtr)(enable ? 0 : 1)
            );
        }
        ...
        public void EnableRadioButton(int buttonId, bool enable)
        {
            ...
            NativeMethods.SendMessage(
                this.handle,
                (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_ENABLE_RADIO_BUTTON,
                (IntPtr)buttonId,
                (IntPtr)(enable ? 0 : 1)
            );
        }
        ...
        public void ClickVerification(bool checkedState, bool setKeyboardFocusToCheckBox)
        {
            ...
            NativeMethods.SendMessage(
                this.handle,
                (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_CLICK_VERIFICATION,
        ...
        public void UpdateContent(string content)
        {
            ...
            NativeMethods.SendMessageWithString(
                this.handle,
                (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_UPDATE_ELEMENT_TEXT,
                (IntPtr)NativeMethods.TASKDIALOG_ELEMENTS.TDE_CONTENT,
                content
            );
        }
        ...
        public void SetButtonElevationRequiredState(int buttonId, bool elevationRequired)
        {
            ...
            NativeMethods.SendMessage(
                this.handle,
                (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_BUTTON_ELEVATION_REQUIRED_STATE,
                (IntPtr)buttonId,
        ...
        public void UpdateFooterIcon(TaskDialogIcon icon)
        {
            ...
            NativeMethods.SendMessage(
                this.handle,
                (uint)NativeMethods.TASKDIALOG_MESSAGES.TDM_UPDATE_ICON,
                (IntPtr)NativeMethods.TASKDIALOG_ICON_ELEMENTS.TDIE_ICON_FOOTER,
                (IntPtr)(uint)icon
            );
        }
