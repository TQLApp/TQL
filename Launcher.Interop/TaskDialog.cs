...
namespace Launcher.Interop
{
    ...
    public delegate bool TaskDialogCallback(
    ...
    public class TaskDialog
    {
        ...
        /// </summary>
        private NativeMethods.TASKDIALOG_FLAGS flags;
        ...
        public bool AllowDialogCancellation
        {
            get
            {
                return (this.flags & NativeMethods.TASKDIALOG_FLAGS.TDF_ALLOW_DIALOG_CANCELLATION)
                    != 0;
            }
            set
            {
                this.SetFlag(NativeMethods.TASKDIALOG_FLAGS.TDF_ALLOW_DIALOG_CANCELLATION, value);
            }
        }
        ...
        public bool UseCommandLinksNoIcon
        {
            get
            {
                return (this.flags & NativeMethods.TASKDIALOG_FLAGS.TDF_USE_COMMAND_LINKS_NO_ICON)
                    != 0;
            }
            set
            {
                this.SetFlag(NativeMethods.TASKDIALOG_FLAGS.TDF_USE_COMMAND_LINKS_NO_ICON, value);
            }
        }
        ...
        public bool ExpandFooterArea
        {
            get
            {
                return (this.flags & NativeMethods.TASKDIALOG_FLAGS.TDF_EXPAND_FOOTER_AREA) != 0;
            }
        ...
        public bool ExpandedByDefault
        {
            get
            {
                return (this.flags & NativeMethods.TASKDIALOG_FLAGS.TDF_EXPANDED_BY_DEFAULT) != 0;
            }
        ...
        public bool VerificationFlagChecked
        {
            get
            {
                return (this.flags & NativeMethods.TASKDIALOG_FLAGS.TDF_VERIFICATION_FLAG_CHECKED)
                    != 0;
            }
            set
            {
                this.SetFlag(NativeMethods.TASKDIALOG_FLAGS.TDF_VERIFICATION_FLAG_CHECKED, value);
            }
        }
        ...
        public bool ShowMarqueeProgressBar
        {
            get
            {
                return (this.flags & NativeMethods.TASKDIALOG_FLAGS.TDF_SHOW_MARQUEE_PROGRESS_BAR)
                    != 0;
            }
            set
            {
                this.SetFlag(NativeMethods.TASKDIALOG_FLAGS.TDF_SHOW_MARQUEE_PROGRESS_BAR, value);
            }
        }
        ...
        public bool PositionRelativeToWindow
        {
            get
            {
                return (this.flags & NativeMethods.TASKDIALOG_FLAGS.TDF_POSITION_RELATIVE_TO_WINDOW)
                    != 0;
            }
            set
            {
                this.SetFlag(NativeMethods.TASKDIALOG_FLAGS.TDF_POSITION_RELATIVE_TO_WINDOW, value);
            }
        }
        ...
        public bool NoDefaultRadioButton
        {
            get
            {
                return (this.flags & NativeMethods.TASKDIALOG_FLAGS.TDF_NO_DEFAULT_RADIO_BUTTON)
                    != 0;
            }
        ...
        )
        {
            ...
            if (!TaskDialog.IsAvailable)
                throw new InvalidOperationException("Task dialog is not available");
            ...
            try
            {
                ...
                if (customButtons.Length > 0)
                {
                    ...
                    for (int i = 0; i < customButtons.Length; i++)
                    {
                        Marshal.StructureToPtr(
                            customButtons[i],
                            (IntPtr)((long)config.pButtons + (elementSize * i)),
                            false
                        );
                ...
                if (customRadioButtons.Length > 0)
                {
                    // Hand marshal the buttons array.
                    int elementSize = Marshal.SizeOf(typeof(TaskDialogButton));
                    config.pRadioButtons = Marshal.AllocHGlobal(
                        elementSize * (int)customRadioButtons.Length
                    );
                    for (int i = 0; i < customRadioButtons.Length; i++)
                    {
                        Marshal.StructureToPtr(
                            customRadioButtons[i],
                            (IntPtr)((long)config.pRadioButtons + (elementSize * i)),
                            false
                        );
                ...
                {
                    config.pfCallback = new NativeMethods.TaskDialogCallback(this.PrivateCallback);
                }
